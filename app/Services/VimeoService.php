...
class VimeoService extends BaseService
{
    ...
    /**
     * Скачать любое видео с Vimeo
     * @param string $url
     * @return array|false
     */
    public function download(string $url): array|false
    {
        $outputPath = storage_path('app/vimeo');
        ...
        $type = 'video'; // можно расширить в будущем под short, showcase и т.д.

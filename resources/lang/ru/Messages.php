...
return [
    'choose_language' => "👋 Привет! Пожалуйста, выберите язык:",
    'choose_download_type' => "Что вы хотите скачать? 🎵 Аудио или 📺 Видео?",
    ...
    'your_video_file' => "✅ Ваш Видео с YouTube! @NinjaDownloaderBot",
    'language_selected' => "Язык успешно выбран! 🇷🇺",
    'link_expired' => "❌ Ссылка устарела или не найдена.",
    'invalid_format' => "❌ Неверный формат.",
    'select_video_format' => "📺 Выберите формат видео:",
